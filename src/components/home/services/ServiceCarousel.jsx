          ...
          <Container className="carousel-card">
            <Row>
              <Col sm={12} md={5} className="">
                <div
                  className="carousel-img m-auto"
                  style={{ width: "100%", backgroundImage: `url(${item.img})` }}
                >
              ...
              <Col sm={12} md={6}>
                <div className=" pt-5 p-relative text-start ">
                  <p className="h4 p-4 text-decoration-underline p-absolute top-0">
                    {item.title} {i + 1}
                  </p>
                  <div className=" p-4 fs-5  ">
                    <p
                      className={`text-justified carousel-text ${
                        !showMore ? "carousel-text-wrap" : ""
                      }`}
                    >
                      {item.text}
                    </p>{" "}
